...
echo "<p>El titulo del segundo libro de la categoria Ciencia Ficcion es: </p>";
...
//    de reseñas).
echo "<p>Muestra la nota que puso el usuario pedro22 en su reseña de Sapiens: </p>";
...
echo "<p>Reseñas de Neuromante: </p>";
if (isset($biblioteca["Ciencia Ficción"][1]["reseñas"])){
    echo $biblioteca["Ciencia Ficción"][1]["reseñas"][0];
} else{
...
echo "<p>Ejemplares de Veinte poemas de amor: </p>";
if (isset($biblioteca["Poesía"][0]["ejemplares"])){
    echo $biblioteca["Poesía"][0]["ejemplares"];
} else{
...
echo "<p>Año nuevo de publicacion de Neuromante: </p>";
...
echo "<p>Categorias y titulos: </p>";
foreach($biblioteca as $b => $cat){
    foreach($cat as $libro){
        echo $b . "->" . $libro["titulo"] . "<br>";
    }
}
